                                                        ...
                                                        <table class="table table-striped">
                                                            ...
                                                            <%                                	
                                                            	for(Produto produto:pedido.getProdutos()){
                                                            		...
                                                            		sb.append("<td>"+ produto.getLivro().getId() +"</td>");
                                                            		sb.append("<td>"+ produto.getLivro().getTitulo() +"</td>");
                                                            		sb.append("<td><label class='form-control' type='text'>"+ produto.getQuantidade() +"</label></td>");
                                            ...
                                            <div class="col-md-4">
                                            	<%
                                            		if(pedido.getStatus().equals("Entregue")){
                                            			...
                                            			sb.append("<a href='Pedido?");
                                            			sb.append("txtId="+ pedido.getId());
                                            			sb.append("&operacao=VISUALIZAR-TROCA' class='btn btn-success btn-block'>Trocar</a>");

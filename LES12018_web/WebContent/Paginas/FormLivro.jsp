	...
	<header>
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			  ...
			  <div class="collapse navbar-collapse" id="navbarNav">
			    <ul class="navbar-nav">
			      <li class="nav-item">
			        <a class="nav-link" href="#">Ger�nciar Pedidos </a>
			      </li>
			      <li class="nav-item">
						...
						<section>
							<fieldset id="fieldset-main">
								...
								<div class="row">
									...
									<div class="col-md-4 mb-3">
										<label class="titulos-label"> <strong> Grupo de Precificação </strong> </label><br>
										...
										<div class="invalid-feedback">
							                  Escolha um Grupo de Previfica��o.
							            </div>
									</div>
								</div>
									<div class="row">
										...
										<div class="col-sm mb-3">
											...
											<input id="txtEdicao" class="form-control" type="text" name="txtEdicao" value="${empty livro ? '' : livro.getEdicao()}" placeholder="Ex: 1� Edi��o" required>
										</div>
					...
					<section>
							...
							<hr class="mb-4">
							 <div class="row" style="${empty livro ? 'display.none' : ''}">
								<div class="col-md mb-6">
									<div class="col-md mb-6">
										<label><strong>Motivo de Inativa��o</strong></label>
								...
								<div class="row" style="${empty livro ? 'display.none' : ''}">
									<div class="col-md mb-6">
										<div class="col-md mb-6">
											<label><strong>Motivo de Ativa��o</strong></label>
						...
						<label class="custom-control custom-checkbox" style="${empty livro ? '' : 'display:none'}">
		       				 <select class="custom-select d-block w-100" name="ckbisAtivo">
		       				 	...
		       				 	<option value="false">Ativa��o</option>
		       				 </select>
		     			 </label>
		     			 	<hr class="mb-4">
		     			 	<div>

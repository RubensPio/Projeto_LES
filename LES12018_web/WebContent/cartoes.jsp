                            ...
                            <div class="row">
                                            ...
                                            <table class="table">
                                                <thead>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <h1><i class="fa fa-cc-visa"></i><a href="alterar-cartao.html"> Cartao 1</a></h1>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <h1><i class="fa fa-cc-mastercard"></i><a href="#"> Cartao de minha mae</a></h1>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                            </table>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div></div>
                                            <form>
                                                <a href="adicionar-cartao.html" class="btn btn-success"><i class="fa fa-plus"></i></a>
                                            </form><br>
                                        </div>
                                    </div>
                    </div>
